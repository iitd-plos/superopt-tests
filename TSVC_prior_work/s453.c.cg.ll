; ModuleID = '/home/adityanathan/superopt-project/superopt-tests/TSVC_prior_work/s453.c'
source_filename = "/home/adityanathan/superopt-project/superopt-tests/TSVC_prior_work/s453.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@val_s = external dso_local local_unnamed_addr global i32, align 4
...
define dso_local i32 @s453() local_unnamed_addr #0 !dbg !7 {
entry:
  call void @llvm.dbg.value(metadata i32 0, metadata !13, metadata !DIExpression()), !dbg !15
  %0 = load i32, i32* @val_s, align 4, !dbg !16
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %uglygep16 = getelementptr i8, i8* bitcast ([32000 x i32]* @b to i8*), i64 %lsr.iv, !dbg !21
  ...
  %1 = mul <4 x i32> %wide.load, %broadcast.splat, !dbg !22
  %2 = mul <4 x i32> %wide.load8, %broadcast.splat10, !dbg !22
  ...
  %uglygep13 = getelementptr i8, i8* bitcast ([32000 x i32]* @b to i8*), i64 %lsr.iv, !dbg !21
  ...
  %3 = mul <4 x i32> %wide.load.1, %broadcast.splat, !dbg !22
  %4 = mul <4 x i32> %wide.load8.1, %broadcast.splat10, !dbg !22
  %uglygep23 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !23
  ...
  %uglygep20 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !23
...
!1 = !DIFile(filename: "/home/adityanathan/superopt-project/superopt-tests/TSVC_prior_work/s453.c", directory: "/home/adityanathan/superopt-project/superopt-tests/build/TSVC_prior_work")
!2 = !{}
...
!7 = distinct !DISubprogram(name: "s453", scope: !8, file: !8, line: 3, type: !9, scopeLine: 4, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !12)
!8 = !DIFile(filename: "TSVC_prior_work/s453.c", directory: "/home/adityanathan/superopt-project/superopt-tests")
...
!17 = distinct !DILexicalBlock(scope: !18, file: !8, line: 8, column: 33)
!18 = distinct !DILexicalBlock(scope: !14, file: !8, line: 8, column: 3)
!19 = !DILocation(line: 8, column: 3, scope: !14)
!20 = !DILocation(line: 8, column: 29, scope: !18)
!21 = !DILocation(line: 9, column: 19, scope: !17)
