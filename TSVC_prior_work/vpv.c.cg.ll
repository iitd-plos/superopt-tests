; ModuleID = '/home/adityanathan/superopt-project/superopt-tests/TSVC_prior_work/vpv.c'
source_filename = "/home/adityanathan/superopt-project/superopt-tests/TSVC_prior_work/vpv.c"
...
define dso_local i32 @vpv() local_unnamed_addr #0 !dbg !7 {
entry:
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %0 = add <4 x i32> %wide.load9, %wide.load, !dbg !21
  %1 = add <4 x i32> %wide.load10, %wide.load8, !dbg !21
  ...
  %2 = add <4 x i32> %wide.load9.1, %wide.load.1, !dbg !21
  %3 = add <4 x i32> %wide.load10.1, %wide.load8.1, !dbg !21
...
!1 = !DIFile(filename: "/home/adityanathan/superopt-project/superopt-tests/TSVC_prior_work/vpv.c", directory: "/home/adityanathan/superopt-project/superopt-tests/build/TSVC_prior_work")
!2 = !{}
...
!7 = distinct !DISubprogram(name: "vpv", scope: !8, file: !8, line: 3, type: !9, scopeLine: 4, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !12)
!8 = !DIFile(filename: "TSVC_prior_work/vpv.c", directory: "/home/adityanathan/superopt-project/superopt-tests")
