...
void check(int name){
	...
	if (name == 25) printf("%d \n",sumb+sume);
	if (name == 13) printf("%d \n",suma+sumc);
	if (name == 123) printf("%d \n",suma+sumb+sumc);
	if (name == 1122) printf("%d \n",sumaa+sumbb);
	if (name == 112233) printf("%d \n",sumaa+sumbb+sumcc);
	if (name == 111) printf("%d \n",sumaa+suma);
	if (name == -1) printf("%d \n",temp);
	if (name == -12) printf("%d \n",temp+sumb);
...
void set(int* ip, TYPE* s1, TYPE* s2){
	xx = (TYPE*) memalign(16, LEN*sizeof(TYPE));
	printf("\n");
...
int main(){
	int n1 = 1;
	int* ip = (int *) memalign(16, LEN*sizeof(TYPE));
	TYPE s1,s2;
	set(ip, &s1, &s2);
