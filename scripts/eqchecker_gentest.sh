...
gen_for_src_dst()
{
  ...
  echo "python ${SUPEROPT_PROJECT_DIR}/superopt/utils/eqbin.py -n ${PWD}/${infile_pfx}_src.${BC_O0_SUFFIX} ${PWD}/${infile_pfx}_dst.${GCC_O3_SUFFIX} ${PWD}/${infile_pfx}_dst.${CLANG_O3_SUFFIX}"
}
...
gen_for_all()
{
  ...
  echo "python ${SUPEROPT_PROJECT_DIR}/superopt/utils/eqbin.py -n ${PWD}/${file_pfx}.${BC_O0_SUFFIX} ${PWD}/${file_pfx}.${GCC_O3_SUFFIX} ${PWD}/${file_pfx}.${CLANG_O3_SUFFIX}"
}
