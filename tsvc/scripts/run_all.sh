...
./parallel-tsvc.sh -c ${CORES} -O '-o "O3" -c "icc" -P" --unroll-factor 8 --global-timeout 30000 --smt-query-timeout 300 --max_lookahead 16"' icc_tsvc_funcs_vec
./parallel-tsvc.sh -c ${CORES} -O '-o "O3" -c "icc" -P" --unroll-factor 2 --global-timeout 30000 --smt-query-timeout 300 --max_lookahead 4"' icc_tsvc_funcs_nonvec
./parallel-tsvc.sh -c ${CORES} -O '-o "O3" -c "icc" -P" --unroll-factor 8 --dst-unroll-factor 5 --global-timeout 30000 --smt-query-timeout 300 --max_lookahead 16"' icc_tsvc_funcs_reroll
