...
g_eqflags["chomp.melt_data.icc"]="--consider_non_vars_for_dst_ineq"
...
#g_eqflags["fannkuch.init_perm1.clang"]="--unroll-factor 8 --max_lookahead 8" # reads from RODATA
...
#g_eqflags["sha1l.do_bench.clang"]="--unroll-factor 8 --max_lookahead 8" # reads from RODATA
