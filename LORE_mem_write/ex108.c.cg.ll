; ModuleID = '/home/adityanathan/superopt-project/superopt-tests/LORE_mem_write/ex108.c'
source_filename = "/home/adityanathan/superopt-project/superopt-tests/LORE_mem_write/ex108.c"
...
define dso_local void @ex108() local_unnamed_addr #0 !dbg !47 {
entry:
  call void @llvm.dbg.value(metadata i32 0, metadata !52, metadata !DIExpression()), !dbg !53
  %0 = load i32, i32* @x, align 4, !dbg !54
  %1 = load i32, i32* @y, align 4, !dbg !54
  %broadcast.splatinsert = insertelement <4 x i32> undef, i32 %0, i32 0, !dbg !57
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> undef, <4 x i32> zeroinitializer, !dbg !57
  %broadcast.splatinsert10 = insertelement <4 x i32> undef, i32 %1, i32 0, !dbg !57
  %broadcast.splat11 = shufflevector <4 x i32> %broadcast.splatinsert10, <4 x i32> undef, <4 x i32> zeroinitializer, !dbg !57
  %broadcast.splatinsert12 = insertelement <4 x i32> undef, i32 %0, i32 0, !dbg !57
  %broadcast.splat13 = shufflevector <4 x i32> %broadcast.splatinsert12, <4 x i32> undef, <4 x i32> zeroinitializer, !dbg !57
  %broadcast.splatinsert14 = insertelement <4 x i32> undef, i32 %1, i32 0, !dbg !57
  %broadcast.splat15 = shufflevector <4 x i32> %broadcast.splatinsert14, <4 x i32> undef, <4 x i32> zeroinitializer, !dbg !57
  br label %vector.body, !dbg !57

vector.body:                                      ; preds = %vector.body, %entry
  %lsr.iv = phi i64 [ %lsr.iv.next, %vector.body ], [ -128000, %entry ], !dbg !58
  %uglygep21 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !59
  %uglygep2122 = bitcast i8* %uglygep21 to <4 x i32>*
  %scevgep23 = getelementptr <4 x i32>, <4 x i32>* %uglygep2122, i64 8000, !dbg !59
  %wide.load = load <4 x i32>, <4 x i32>* %scevgep23, align 16, !dbg !59
  %scevgep24 = getelementptr <4 x i32>, <4 x i32>* %uglygep2122, i64 8001, !dbg !59
  %wide.load9 = load <4 x i32>, <4 x i32>* %scevgep24, align 16, !dbg !59
  %2 = icmp slt <4 x i32> %wide.load, zeroinitializer, !dbg !60
  %3 = icmp slt <4 x i32> %wide.load9, zeroinitializer, !dbg !60
  %4 = select <4 x i1> %2, <4 x i32> %broadcast.splat, <4 x i32> %broadcast.splat11, !dbg !59
  %5 = select <4 x i1> %3, <4 x i32> %broadcast.splat13, <4 x i32> %broadcast.splat15, !dbg !59
  ...
  store <4 x i32> %4, <4 x i32>* %scevgep33, align 16, !dbg !61
  %scevgep34 = getelementptr <4 x i32>, <4 x i32>* %uglygep3132, i64 8001, !dbg !61
  store <4 x i32> %5, <4 x i32>* %scevgep34, align 16, !dbg !61
  %uglygep18 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !59
  %uglygep1819 = bitcast i8* %uglygep18 to <4 x i32>*
  %scevgep20 = getelementptr <4 x i32>, <4 x i32>* %uglygep1819, i64 8002, !dbg !59
  %wide.load.1 = load <4 x i32>, <4 x i32>* %scevgep20, align 16, !dbg !59
  %uglygep = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !59
  %uglygep17 = bitcast i8* %uglygep to <4 x i32>*
  %scevgep = getelementptr <4 x i32>, <4 x i32>* %uglygep17, i64 8003, !dbg !59
  %wide.load9.1 = load <4 x i32>, <4 x i32>* %scevgep, align 16, !dbg !59
  %6 = icmp slt <4 x i32> %wide.load.1, zeroinitializer, !dbg !60
  %7 = icmp slt <4 x i32> %wide.load9.1, zeroinitializer, !dbg !60
  %8 = select <4 x i1> %6, <4 x i32> %broadcast.splat, <4 x i32> %broadcast.splat11, !dbg !59
  %9 = select <4 x i1> %7, <4 x i32> %broadcast.splat13, <4 x i32> %broadcast.splat15, !dbg !59
  ...
  store <4 x i32> %8, <4 x i32>* %scevgep30, align 16, !dbg !61
  ...
  store <4 x i32> %9, <4 x i32>* %scevgep27, align 16, !dbg !61
  %lsr.iv.next = add nsw i64 %lsr.iv, 64, !dbg !58
  %10 = icmp eq i64 %lsr.iv.next, 0, !dbg !58
  br i1 %10, label %for.end, label %vector.body, !dbg !58, !llvm.loop !62
...
!3 = !DIFile(filename: "/home/adityanathan/superopt-project/superopt-tests/LORE_mem_write/ex108.c", directory: "/home/adityanathan/superopt-project/superopt-tests/build/LORE_mem_write")
!4 = !{}
...
!47 = distinct !DISubprogram(name: "ex108", scope: !48, file: !48, line: 5, type: !49, scopeLine: 6, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !51)
!48 = !DIFile(filename: "LORE_mem_write/ex108.c", directory: "/home/adityanathan/superopt-project/superopt-tests")
...
!55 = distinct !DILexicalBlock(scope: !56, file: !48, line: 8, column: 3)
!56 = distinct !DILexicalBlock(scope: !47, file: !48, line: 8, column: 3)
!57 = !DILocation(line: 8, column: 3, scope: !56)
!58 = !DILocation(line: 8, column: 25, scope: !55)
!59 = !DILocation(line: 9, column: 12, scope: !55)
!60 = !DILocation(line: 9, column: 17, scope: !55)
!61 = !DILocation(line: 9, column: 10, scope: !55)
!62 = distinct !{!62, !57, !63, !64}
!63 = !DILocation(line: 9, column: 27, scope: !56)
!64 = !{!"llvm.loop.isvectorized", i32 1}
!65 = !DILocation(line: 10, column: 1, scope: !47)
