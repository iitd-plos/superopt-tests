; ModuleID = '/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s272.c'
source_filename = "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s272.c"
...
define dso_local i32 @s272(i32 %t) local_unnamed_addr #0 !dbg !64 {
entry:
  call void @llvm.dbg.value(metadata i32 %t, metadata !69, metadata !DIExpression()), !dbg !72
...
for.body:                                         ; preds = %entry, %for.inc
  ...
  %uglygep37 = getelementptr i8, i8* bitcast ([32000 x i32]* @e to i8*), i64 %lsr.iv, !dbg !76
  %uglygep3738 = bitcast i8* %uglygep37 to i32*
  %scevgep39 = getelementptr i32, i32* %uglygep3738, i64 32000, !dbg !76
  %0 = load i32, i32* %scevgep39, align 4, !dbg !76
  %cmp1.not = icmp slt i32 %0, %t, !dbg !80
  br i1 %cmp1.not, label %for.inc, label %if.then, !dbg !81

if.then:                                          ; preds = %for.body
  %uglygep34 = getelementptr i8, i8* bitcast ([32000 x i32]* @c to i8*), i64 %lsr.iv, !dbg !82
  %uglygep3435 = bitcast i8* %uglygep34 to i32*
  %scevgep36 = getelementptr i32, i32* %uglygep3435, i64 32000, !dbg !82
  %1 = load i32, i32* %scevgep36, align 4, !dbg !82
  %uglygep31 = getelementptr i8, i8* bitcast ([32000 x i32]* @d to i8*), i64 %lsr.iv, !dbg !84
  %uglygep3132 = bitcast i8* %uglygep31 to i32*
  %scevgep33 = getelementptr i32, i32* %uglygep3132, i64 32000, !dbg !84
  %2 = load i32, i32* %scevgep33, align 4, !dbg !84
  %mul = mul i32 %2, %1, !dbg !85
  %uglygep28 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !86
  %uglygep2829 = bitcast i8* %uglygep28 to i32*
  %scevgep30 = getelementptr i32, i32* %uglygep2829, i64 32000, !dbg !86
  %3 = load i32, i32* %scevgep30, align 4, !dbg !86
  %add = add i32 %3, %mul, !dbg !86
  store i32 %add, i32* %scevgep30, align 4, !dbg !86
  %mul12 = mul i32 %1, %1, !dbg !87
  %uglygep = getelementptr i8, i8* bitcast ([32000 x i32]* @b to i8*), i64 %lsr.iv, !dbg !88
  %uglygep27 = bitcast i8* %uglygep to i32*
  %scevgep = getelementptr i32, i32* %uglygep27, i64 32000, !dbg !88
  %4 = load i32, i32* %scevgep, align 4, !dbg !88
  %add15 = add i32 %4, %mul12, !dbg !88
  store i32 %add15, i32* %scevgep, align 4, !dbg !88
...
for.inc:                                          ; preds = %for.body, %if.then
  ...
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body, !dbg !74, !llvm.loop !91

; uselistorder directives
  uselistorder i32* %scevgep, { 1, 0 }
  uselistorder i32* %scevgep30, { 1, 0 }
  uselistorder i32 %1, { 1, 0, 2 }
  uselistorder i64 %lsr.iv, { 5, 4, 3, 2, 1, 0 }
  uselistorder i64 32000, { 4, 3, 2, 1, 0 }
  uselistorder [32000 x i32] zeroinitializer, { 0, 1, 7, 8, 9, 10, 11, 12, 5, 6, 3, 4, 2 }
  uselistorder i32 0, { 1, 0 }
  uselistorder void (metadata, metadata, metadata)* @llvm.dbg.value, { 1, 0, 2, 3 }
...
!3 = !DIFile(filename: "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s272.c", directory: "/home/adityanathan/superopt-project/superopt-tests/build/TSVC_new")
!4 = !{}
...
!64 = distinct !DISubprogram(name: "s272", scope: !65, file: !65, line: 3, type: !66, scopeLine: 4, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !68)
!65 = !DIFile(filename: "TSVC_new/s272.c", directory: "/home/adityanathan/superopt-project/superopt-tests")
!66 = !DISubroutineType(types: !67)
!67 = !{!10, !10}
!68 = !{!69, !70}
!69 = !DILocalVariable(name: "t", arg: 1, scope: !64, file: !65, line: 3, type: !10)
...
!76 = !DILocation(line: 10, column: 8, scope: !77)
!77 = distinct !DILexicalBlock(scope: !78, file: !65, line: 10, column: 8)
!78 = distinct !DILexicalBlock(scope: !79, file: !65, line: 9, column: 33)
!79 = distinct !DILexicalBlock(scope: !71, file: !65, line: 9, column: 3)
!80 = !DILocation(line: 10, column: 13, scope: !77)
!81 = !DILocation(line: 10, column: 8, scope: !78)
!82 = !DILocation(line: 11, column: 13, scope: !83)
!83 = distinct !DILexicalBlock(scope: !77, file: !65, line: 10, column: 19)
!84 = !DILocation(line: 11, column: 20, scope: !83)
!85 = !DILocation(line: 11, column: 18, scope: !83)
!86 = !DILocation(line: 11, column: 10, scope: !83)
!87 = !DILocation(line: 12, column: 18, scope: !83)
!88 = !DILocation(line: 12, column: 10, scope: !83)
!89 = !DILocation(line: 13, column: 4, scope: !83)
!90 = !DILocation(line: 9, column: 21, scope: !79)
!91 = distinct !{!91, !74, !92}
!92 = !DILocation(line: 14, column: 3, scope: !71)
