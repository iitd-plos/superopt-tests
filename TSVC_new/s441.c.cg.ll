; ModuleID = '/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s441.c'
source_filename = "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s441.c"
...
define dso_local i32 @s441() local_unnamed_addr #0 !dbg !65 {
entry:
...
for.body:                                         ; preds = %entry, %for.inc
  ...
  %uglygep59 = getelementptr i8, i8* bitcast ([32000 x i32]* @d to i8*), i64 %lsr.iv, !dbg !74
  %uglygep5960 = bitcast i8* %uglygep59 to i32*
  %scevgep61 = getelementptr i32, i32* %uglygep5960, i64 32000, !dbg !74
  %0 = load i32, i32* %scevgep61, align 4, !dbg !74
  %cmp1 = icmp slt i32 %0, 0, !dbg !78
  br i1 %cmp1, label %if.then, label %if.else, !dbg !79

if.then:                                          ; preds = %for.body
  %uglygep56 = getelementptr i8, i8* bitcast ([32000 x i32]* @b to i8*), i64 %lsr.iv, !dbg !80
  %uglygep5657 = bitcast i8* %uglygep56 to i32*
  %scevgep58 = getelementptr i32, i32* %uglygep5657, i64 32000, !dbg !80
  %1 = load i32, i32* %scevgep58, align 4, !dbg !80
  %uglygep50 = getelementptr i8, i8* bitcast ([32000 x i32]* @c to i8*), i64 %lsr.iv, !dbg !82
  %uglygep5051 = bitcast i8* %uglygep50 to i32*
  %scevgep52 = getelementptr i32, i32* %uglygep5051, i64 32000, !dbg !82
  %2 = load i32, i32* %scevgep52, align 4, !dbg !82
  %mul = mul i32 %2, %1, !dbg !83
  br label %for.inc, !dbg !84

if.else:                                          ; preds = %for.body
  %cmp10 = icmp eq i32 %0, 0, !dbg !85
  br i1 %cmp10, label %if.then11, label %if.else20, !dbg !87

if.then11:                                        ; preds = %if.else
  %uglygep53 = getelementptr i8, i8* bitcast ([32000 x i32]* @b to i8*), i64 %lsr.iv, !dbg !88
  %uglygep5354 = bitcast i8* %uglygep53 to i32*
  %scevgep55 = getelementptr i32, i32* %uglygep5354, i64 32000, !dbg !88
  %3 = load i32, i32* %scevgep55, align 4, !dbg !88
  %mul16 = mul i32 %3, %3, !dbg !90
  br label %for.inc, !dbg !91

if.else20:                                        ; preds = %if.else
  %uglygep47 = getelementptr i8, i8* bitcast ([32000 x i32]* @c to i8*), i64 %lsr.iv, !dbg !92
  %uglygep4748 = bitcast i8* %uglygep47 to i32*
  %scevgep49 = getelementptr i32, i32* %uglygep4748, i64 32000, !dbg !92
  %4 = load i32, i32* %scevgep49, align 4, !dbg !92
  %mul25 = mul i32 %4, %4, !dbg !94
  br label %for.inc

for.inc:                                          ; preds = %if.then, %if.else20, %if.then11
  %mul.sink = phi i32 [ %mul, %if.then ], [ %mul25, %if.else20 ], [ %mul16, %if.then11 ]
  %uglygep = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !95
  %uglygep46 = bitcast i8* %uglygep to i32*
  %scevgep = getelementptr i32, i32* %uglygep46, i64 32000, !dbg !95
  %5 = load i32, i32* %scevgep, align 4, !dbg !95
  %add = add i32 %5, %mul.sink, !dbg !95
  store i32 %add, i32* %scevgep, align 4, !dbg !95
  ...
  %lsr.iv.next = add nsw i64 %lsr.iv, 4, !dbg !96
  %exitcond.not = icmp eq i64 %lsr.iv.next, 0, !dbg !96
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body, !dbg !72, !llvm.loop !97
...
!3 = !DIFile(filename: "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s441.c", directory: "/home/adityanathan/superopt-project/superopt-tests/build/TSVC_new")
!4 = !{}
!5 = !{!6}
...
!65 = distinct !DISubprogram(name: "s441", scope: !66, file: !66, line: 3, type: !67, scopeLine: 4, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !68)
!66 = !DIFile(filename: "TSVC_new/s441.c", directory: "/home/adityanathan/superopt-project/superopt-tests")
...
!72 = !DILocation(line: 9, column: 4, scope: !70)
!73 = !DILocation(line: 18, column: 3, scope: !65)
!74 = !DILocation(line: 10, column: 9, scope: !75)
!75 = distinct !DILexicalBlock(scope: !76, file: !66, line: 10, column: 9)
!76 = distinct !DILexicalBlock(scope: !77, file: !66, line: 9, column: 34)
!77 = distinct !DILexicalBlock(scope: !70, file: !66, line: 9, column: 4)
!78 = !DILocation(line: 10, column: 14, scope: !75)
!79 = !DILocation(line: 10, column: 9, scope: !76)
!80 = !DILocation(line: 11, column: 14, scope: !81)
!81 = distinct !DILexicalBlock(scope: !75, file: !66, line: 10, column: 26)
!82 = !DILocation(line: 11, column: 21, scope: !81)
!83 = !DILocation(line: 11, column: 19, scope: !81)
!84 = !DILocation(line: 12, column: 5, scope: !81)
!85 = !DILocation(line: 12, column: 21, scope: !86)
!86 = distinct !DILexicalBlock(scope: !75, file: !66, line: 12, column: 16)
!87 = !DILocation(line: 12, column: 16, scope: !75)
!88 = !DILocation(line: 13, column: 14, scope: !89)
!89 = distinct !DILexicalBlock(scope: !86, file: !66, line: 12, column: 34)
!90 = !DILocation(line: 13, column: 19, scope: !89)
!91 = !DILocation(line: 14, column: 5, scope: !89)
!92 = !DILocation(line: 15, column: 14, scope: !93)
!93 = distinct !DILexicalBlock(scope: !86, file: !66, line: 14, column: 12)
!94 = !DILocation(line: 15, column: 19, scope: !93)
!95 = !DILocation(line: 0, scope: !75)
!96 = !DILocation(line: 9, column: 22, scope: !77)
!97 = distinct !{!97, !72, !98}
!98 = !DILocation(line: 17, column: 4, scope: !70)
