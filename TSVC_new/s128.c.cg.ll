; ModuleID = '/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s128.c'
source_filename = "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s128.c"
...
define dso_local i32 @s128() local_unnamed_addr #0 !dbg !64 {
entry:
...
for.body:                                         ; preds = %for.body, %entry
  ...
  call void @llvm.dbg.value(metadata i64 undef, metadata !69, metadata !DIExpression()), !dbg !73
  ...
  %0 = shl nuw nsw i64 %lsr.iv, 1, !dbg !77
  %uglygep34 = getelementptr i8, i8* bitcast ([32000 x i32]* @b to i8*), i64 %0, !dbg !77
  %uglygep3435 = bitcast i8* %uglygep34 to i32*
  %1 = load i32, i32* %uglygep3435, align 4, !dbg !77
  %uglygep40 = getelementptr i8, i8* bitcast ([32000 x i32]* @d to i8*), i64 %lsr.iv, !dbg !80
  %uglygep4041 = bitcast i8* %uglygep40 to i32*
  %2 = load i32, i32* %uglygep4041, align 8, !dbg !80
  %sub = sub i32 %1, %2, !dbg !81
  %uglygep45 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !82
  %uglygep4546 = bitcast i8* %uglygep45 to i32*
  store i32 %sub, i32* %uglygep4546, align 8, !dbg !82
  call void @llvm.dbg.value(metadata i64 undef, metadata !69, metadata !DIExpression(DW_OP_plus_uconst, 2, DW_OP_stack_value)), !dbg !73
  %3 = shl nuw nsw i64 %lsr.iv, 1, !dbg !83
  %uglygep29 = getelementptr i8, i8* bitcast ([32000 x i32]* @c to i8*), i64 %3, !dbg !83
  %uglygep2930 = bitcast i8* %uglygep29 to i32*
  %4 = load i32, i32* %uglygep2930, align 4, !dbg !83
  %add10 = add i32 %4, %sub, !dbg !84
  store i32 %add10, i32* %uglygep3435, align 4, !dbg !85
  ...
  call void @llvm.dbg.value(metadata i64 undef, metadata !70, metadata !DIExpression(DW_OP_plus_uconst, 3, DW_OP_stack_value)), !dbg !73
  %5 = shl nuw nsw i64 %lsr.iv, 1, !dbg !77
  %uglygep31 = getelementptr i8, i8* bitcast ([32000 x i32]* @b to i8*), i64 %5, !dbg !77
  %uglygep3132 = bitcast i8* %uglygep31 to i32*
  %scevgep33 = getelementptr i32, i32* %uglygep3132, i64 2, !dbg !77
  %6 = load i32, i32* %scevgep33, align 4, !dbg !77
  %uglygep37 = getelementptr i8, i8* bitcast ([32000 x i32]* @d to i8*), i64 %lsr.iv, !dbg !80
  %uglygep3738 = bitcast i8* %uglygep37 to i32*
  %scevgep39 = getelementptr i32, i32* %uglygep3738, i64 1, !dbg !80
  %7 = load i32, i32* %scevgep39, align 4, !dbg !80
  %sub.1 = sub i32 %6, %7, !dbg !81
  %uglygep42 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !82
  %uglygep4243 = bitcast i8* %uglygep42 to i32*
  %scevgep44 = getelementptr i32, i32* %uglygep4243, i64 1, !dbg !82
  store i32 %sub.1, i32* %scevgep44, align 4, !dbg !82
  call void @llvm.dbg.value(metadata i64 undef, metadata !69, metadata !DIExpression(DW_OP_plus_uconst, 4, DW_OP_stack_value)), !dbg !73
  %8 = shl nuw nsw i64 %lsr.iv, 1, !dbg !83
  %uglygep = getelementptr i8, i8* bitcast ([32000 x i32]* @c to i8*), i64 %8, !dbg !83
  %uglygep28 = bitcast i8* %uglygep to i32*
  %scevgep = getelementptr i32, i32* %uglygep28, i64 2, !dbg !83
  %9 = load i32, i32* %scevgep, align 4, !dbg !83
  %add10.1 = add i32 %9, %sub.1, !dbg !84
  store i32 %add10.1, i32* %scevgep33, align 4, !dbg !85
  call void @llvm.dbg.value(metadata i64 undef, metadata !71, metadata !DIExpression(DW_OP_plus_uconst, 2, DW_OP_stack_value)), !dbg !74
  %lsr.iv.next = add nuw nsw i64 %lsr.iv, 8, !dbg !86
  %exitcond.not.1 = icmp eq i64 %lsr.iv.next, 64000, !dbg !86
  br i1 %exitcond.not.1, label %for.cond.cleanup, label %for.body, !dbg !75, !llvm.loop !87

; uselistorder directives
  uselistorder i32* %scevgep33, { 1, 0 }
  uselistorder i32* %uglygep3435, { 1, 0 }
  uselistorder i64 %lsr.iv, { 8, 7, 1, 3, 5, 6, 0, 2, 4 }
  ...
  uselistorder [32000 x i32] zeroinitializer, { 0, 1, 2, 7, 8, 9, 10, 11, 12, 4, 6, 3, 5 }
  uselistorder i8* bitcast ([32000 x i32]* @b to i8*), { 1, 0 }
  uselistorder i64 1, { 5, 0, 1, 3, 4, 2 }
  uselistorder i32 0, { 1, 0 }
  uselistorder void (metadata, metadata, metadata)* @llvm.dbg.value, { 0, 1, 2, 6, 5, 9, 4, 3, 7, 8 }
}
...
!3 = !DIFile(filename: "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s128.c", directory: "/home/adityanathan/superopt-project/superopt-tests/build/TSVC_new")
!4 = !{}
...
!64 = distinct !DISubprogram(name: "s128", scope: !65, file: !65, line: 3, type: !66, scopeLine: 4, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !68)
!65 = !DIFile(filename: "TSVC_new/s128.c", directory: "/home/adityanathan/superopt-project/superopt-tests")
!66 = !DISubroutineType(types: !67)
!67 = !{!10}
!68 = !{!69, !70, !71}
!69 = !DILocalVariable(name: "j", scope: !64, file: !65, line: 10, type: !10)
!70 = !DILocalVariable(name: "k", scope: !64, file: !65, line: 10, type: !10)
...
!76 = !DILocation(line: 18, column: 2, scope: !64)
!77 = !DILocation(line: 14, column: 11, scope: !78)
!78 = distinct !DILexicalBlock(scope: !79, file: !65, line: 12, column: 35)
!79 = distinct !DILexicalBlock(scope: !72, file: !65, line: 12, column: 3)
!80 = !DILocation(line: 14, column: 18, scope: !78)
!81 = !DILocation(line: 14, column: 16, scope: !78)
!82 = !DILocation(line: 14, column: 9, scope: !78)
!83 = !DILocation(line: 16, column: 18, scope: !78)
!84 = !DILocation(line: 16, column: 16, scope: !78)
!85 = !DILocation(line: 16, column: 9, scope: !78)
!86 = !DILocation(line: 12, column: 21, scope: !79)
!87 = distinct !{!87, !75, !88}
!88 = !DILocation(line: 17, column: 3, scope: !72)
