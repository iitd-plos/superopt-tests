; ModuleID = '/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s311.c'
source_filename = "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s311.c"
...
define dso_local i32 @s311() local_unnamed_addr #0 !dbg !65 {
entry:
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %scevgep31 = getelementptr <4 x i32>, <4 x i32>* %uglygep2930, i64 8000, !dbg !77
  %wide.load = load <4 x i32>, <4 x i32>* %scevgep31, align 16, !dbg !77
  %scevgep32 = getelementptr <4 x i32>, <4 x i32>* %uglygep2930, i64 8001, !dbg !77
  %wide.load9 = load <4 x i32>, <4 x i32>* %scevgep32, align 16, !dbg !77
  %0 = add <4 x i32> %wide.load, %vec.phi, !dbg !79
  %1 = add <4 x i32> %wide.load9, %vec.phi8, !dbg !79
  %uglygep36 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !77
  %uglygep3637 = bitcast i8* %uglygep36 to <4 x i32>*
  %scevgep38 = getelementptr <4 x i32>, <4 x i32>* %uglygep3637, i64 8002, !dbg !77
  %wide.load.1 = load <4 x i32>, <4 x i32>* %scevgep38, align 16, !dbg !77
  %uglygep33 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !77
  %uglygep3334 = bitcast i8* %uglygep33 to <4 x i32>*
  %scevgep35 = getelementptr <4 x i32>, <4 x i32>* %uglygep3334, i64 8003, !dbg !77
  %wide.load9.1 = load <4 x i32>, <4 x i32>* %scevgep35, align 16, !dbg !77
  %2 = add <4 x i32> %wide.load.1, %0, !dbg !79
  %3 = add <4 x i32> %wide.load9.1, %1, !dbg !79
  %uglygep26 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !77
  %uglygep2627 = bitcast i8* %uglygep26 to <4 x i32>*
  %scevgep28 = getelementptr <4 x i32>, <4 x i32>* %uglygep2627, i64 8004, !dbg !77
  %wide.load.2 = load <4 x i32>, <4 x i32>* %scevgep28, align 16, !dbg !77
  %uglygep23 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !77
  %uglygep2324 = bitcast i8* %uglygep23 to <4 x i32>*
  %scevgep25 = getelementptr <4 x i32>, <4 x i32>* %uglygep2324, i64 8005, !dbg !77
  %wide.load9.2 = load <4 x i32>, <4 x i32>* %scevgep25, align 16, !dbg !77
  %4 = add <4 x i32> %wide.load.2, %2, !dbg !79
  %5 = add <4 x i32> %wide.load9.2, %3, !dbg !79
  %uglygep20 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !77
  %uglygep2021 = bitcast i8* %uglygep20 to <4 x i32>*
  %scevgep22 = getelementptr <4 x i32>, <4 x i32>* %uglygep2021, i64 8006, !dbg !77
  %wide.load.3 = load <4 x i32>, <4 x i32>* %scevgep22, align 16, !dbg !77
  %uglygep17 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !77
  %uglygep1718 = bitcast i8* %uglygep17 to <4 x i32>*
  %scevgep19 = getelementptr <4 x i32>, <4 x i32>* %uglygep1718, i64 8007, !dbg !77
  %wide.load9.3 = load <4 x i32>, <4 x i32>* %scevgep19, align 16, !dbg !77
  %6 = add <4 x i32> %wide.load.3, %4, !dbg !79
  %7 = add <4 x i32> %wide.load9.3, %5, !dbg !79
  %uglygep14 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !77
  %uglygep1415 = bitcast i8* %uglygep14 to <4 x i32>*
  %scevgep16 = getelementptr <4 x i32>, <4 x i32>* %uglygep1415, i64 8008, !dbg !77
  %wide.load.4 = load <4 x i32>, <4 x i32>* %scevgep16, align 16, !dbg !77
  %uglygep = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !77
  %uglygep13 = bitcast i8* %uglygep to <4 x i32>*
  %scevgep = getelementptr <4 x i32>, <4 x i32>* %uglygep13, i64 8009, !dbg !77
  %wide.load9.4 = load <4 x i32>, <4 x i32>* %scevgep, align 16, !dbg !77
  %8 = add <4 x i32> %wide.load.4, %6, !dbg !79
  %9 = add <4 x i32> %wide.load9.4, %7, !dbg !79
  %lsr.iv.next = add nsw i64 %lsr.iv, 160, !dbg !75
  %10 = icmp eq i64 %lsr.iv.next, 0, !dbg !75
  br i1 %10, label %middle.block, label %vector.body, !dbg !75, !llvm.loop !80

middle.block:                                     ; preds = %vector.body
  %bin.rdx = add <4 x i32> %9, %8, !dbg !74
  %rdx.shuf = shufflevector <4 x i32> %bin.rdx, <4 x i32> undef, <4 x i32> <i32 2, i32 3, i32 undef, i32 undef>, !dbg !74
  %bin.rdx39 = add <4 x i32> %bin.rdx, %rdx.shuf, !dbg !74
  %rdx.shuf40 = shufflevector <4 x i32> %bin.rdx39, <4 x i32> undef, <4 x i32> <i32 1, i32 undef, i32 undef, i32 undef>, !dbg !74
  %bin.rdx41 = add <4 x i32> %bin.rdx39, %rdx.shuf40, !dbg !74
  %11 = extractelement <4 x i32> %bin.rdx41, i32 0, !dbg !74
  call void @llvm.dbg.value(metadata i32 %11, metadata !69, metadata !DIExpression()), !dbg !72
  store i32 %11, i32* @temp, align 4, !dbg !83
  ret i32 0, !dbg !84
...
!3 = !DIFile(filename: "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s311.c", directory: "/home/adityanathan/superopt-project/superopt-tests/build/TSVC_new")
!4 = !{}
!5 = !{!6}
...
!65 = distinct !DISubprogram(name: "s311", scope: !66, file: !66, line: 3, type: !67, scopeLine: 4, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !68)
!66 = !DIFile(filename: "TSVC_new/s311.c", directory: "/home/adityanathan/superopt-project/superopt-tests")
...
!78 = distinct !DILexicalBlock(scope: !76, file: !66, line: 11, column: 33)
!79 = !DILocation(line: 12, column: 8, scope: !78)
!80 = distinct !{!80, !74, !81, !82}
!81 = !DILocation(line: 13, column: 3, scope: !71)
!82 = !{!"llvm.loop.isvectorized", i32 1}
!83 = !DILocation(line: 14, column: 8, scope: !65)
!84 = !DILocation(line: 15, column: 2, scope: !65)
