; ModuleID = '/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s293.c'
source_filename = "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s293.c"
...
define dso_local i32 @s293() local_unnamed_addr #0 !dbg !64 {
entry:
...
for.body:                                         ; preds = %for.body, %entry
  %lsr.iv = phi i64 [ %lsr.iv.next, %for.body ], [ -128000, %entry ]
  ...
  %uglygep13 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !77
  %uglygep1314 = bitcast i8* %uglygep13 to i32*
  %scevgep15 = getelementptr i32, i32* %uglygep1314, i64 32000, !dbg !77
  store i32 %0, i32* %scevgep15, align 4, !dbg !77
  ...
  %1 = load i32, i32* getelementptr inbounds ([32000 x i32], [32000 x i32]* @a, i64 0, i64 0), align 16, !dbg !74
  %uglygep16 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !77
  %uglygep1617 = bitcast i8* %uglygep16 to i32*
  %scevgep18 = getelementptr i32, i32* %uglygep1617, i64 32001, !dbg !77
  store i32 %1, i32* %scevgep18, align 4, !dbg !77
  ...
  %uglygep10 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !77
  %uglygep1011 = bitcast i8* %uglygep10 to i32*
  %scevgep12 = getelementptr i32, i32* %uglygep1011, i64 32002, !dbg !77
  store i32 %1, i32* %scevgep12, align 4, !dbg !77
  ...
  %uglygep7 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %lsr.iv, !dbg !77
  %uglygep78 = bitcast i8* %uglygep7 to i32*
  %scevgep9 = getelementptr i32, i32* %uglygep78, i64 32003, !dbg !77
  store i32 %2, i32* %scevgep9, align 4, !dbg !77
  ...
  %scevgep = getelementptr i32, i32* %uglygep6, i64 32004, !dbg !77
  store i32 %2, i32* %scevgep, align 4, !dbg !77
  call void @llvm.dbg.value(metadata i64 undef, metadata !69, metadata !DIExpression(DW_OP_plus_uconst, 5, DW_OP_stack_value)), !dbg !71
  %lsr.iv.next = add nsw i64 %lsr.iv, 20, !dbg !78
  %exitcond.not.4 = icmp eq i64 %lsr.iv.next, 0, !dbg !78
  br i1 %exitcond.not.4, label %for.cond.cleanup, label %for.body, !dbg !72, !llvm.loop !79

; uselistorder directives
  uselistorder i64 %lsr.iv, { 5, 4, 3, 2, 0, 1 }
...
!3 = !DIFile(filename: "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s293.c", directory: "/home/adityanathan/superopt-project/superopt-tests/build/TSVC_new")
!4 = !{}
...
!64 = distinct !DISubprogram(name: "s293", scope: !65, file: !65, line: 3, type: !66, scopeLine: 4, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !68)
!65 = !DIFile(filename: "TSVC_new/s293.c", directory: "/home/adityanathan/superopt-project/superopt-tests")
...
!78 = !DILocation(line: 9, column: 21, scope: !76)
!79 = distinct !{!79, !72, !80}
!80 = !DILocation(line: 11, column: 3, scope: !70)
