; ModuleID = '/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s2711.c'
source_filename = "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s2711.c"
...
define dso_local i32 @s2711() local_unnamed_addr #0 !dbg !65 {
entry:
...
vector.body:                                      ; preds = %pred.store.continue22, %entry
  ...
  %0 = icmp ne <4 x i32> %wide.load, zeroinitializer, !dbg !78
...
pred.store.continue:                              ; preds = %pred.store.if, %vector.body
  %6 = icmp ne <4 x i32> %wide.load, zeroinitializer, !dbg !78
...
pred.store.continue18:                            ; preds = %pred.store.if17, %pred.store.continue
  %9 = icmp ne <4 x i32> %wide.load, zeroinitializer, !dbg !78
...
pred.store.continue20:                            ; preds = %pred.store.if19, %pred.store.continue18
  %12 = icmp ne <4 x i32> %wide.load, zeroinitializer, !dbg !78
...
!3 = !DIFile(filename: "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s2711.c", directory: "/home/adityanathan/superopt-project/superopt-tests/build/TSVC_new")
!4 = !{}
!5 = !{!6}
...
!65 = distinct !DISubprogram(name: "s2711", scope: !66, file: !66, line: 3, type: !67, scopeLine: 4, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !68)
!66 = !DIFile(filename: "TSVC_new/s2711.c", directory: "/home/adityanathan/superopt-project/superopt-tests")
...
!79 = !DILocation(line: 11, column: 20, scope: !80)
!80 = distinct !DILexicalBlock(scope: !76, file: !66, line: 10, column: 27)
!81 = !DILocation(line: 11, column: 18, scope: !80)
!82 = !DILocation(line: 11, column: 10, scope: !80)
!83 = distinct !{!83, !72, !84, !85}
!84 = !DILocation(line: 13, column: 3, scope: !70)
!85 = !{!"llvm.loop.isvectorized", i32 1}
!86 = !DILocation(line: 14, column: 2, scope: !65)
