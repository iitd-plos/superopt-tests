; ModuleID = '/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s111.c'
source_filename = "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s111.c"
...
define dso_local i32 @s111() local_unnamed_addr #0 !dbg !64 {
entry:
...
for.body:                                         ; preds = %for.body, %entry
  %lsr.iv = phi i64 [ %lsr.iv.next, %for.body ], [ -3, %entry ]
  call void @llvm.dbg.value(metadata i64 undef, metadata !69, metadata !DIExpression()), !dbg !71
  %0 = shl nsw i64 %lsr.iv, 2, !dbg !74
  %uglygep14 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %0, !dbg !74
  %uglygep1415 = bitcast i8* %uglygep14 to i32*
  %scevgep16 = getelementptr i32, i32* %uglygep1415, i64 3, !dbg !74
  %1 = load i32, i32* %scevgep16, align 4, !dbg !74
  %2 = shl nsw i64 %lsr.iv, 2, !dbg !77
  %uglygep23 = getelementptr i8, i8* bitcast ([32000 x i32]* @b to i8*), i64 %2, !dbg !77
  %uglygep2324 = bitcast i8* %uglygep23 to i32*
  %scevgep25 = getelementptr i32, i32* %uglygep2324, i64 4, !dbg !77
  %3 = load i32, i32* %scevgep25, align 4, !dbg !77
  %add = add i32 %3, %1, !dbg !78
  %4 = shl nsw i64 %lsr.iv, 2, !dbg !79
  %uglygep17 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %4, !dbg !79
  %uglygep1718 = bitcast i8* %uglygep17 to i32*
  %scevgep19 = getelementptr i32, i32* %uglygep1718, i64 4, !dbg !79
  store i32 %add, i32* %scevgep19, align 4, !dbg !79
  ...
  %5 = shl nsw i64 %lsr.iv, 2, !dbg !74
  %uglygep = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %5, !dbg !74
  %uglygep13 = bitcast i8* %uglygep to i32*
  %scevgep = getelementptr i32, i32* %uglygep13, i64 5, !dbg !74
  %6 = load i32, i32* %scevgep, align 4, !dbg !74
  %7 = shl nsw i64 %lsr.iv, 2, !dbg !77
  %uglygep26 = getelementptr i8, i8* bitcast ([32000 x i32]* @b to i8*), i64 %7, !dbg !77
  %uglygep2627 = bitcast i8* %uglygep26 to i32*
  %scevgep28 = getelementptr i32, i32* %uglygep2627, i64 6, !dbg !77
  %8 = load i32, i32* %scevgep28, align 4, !dbg !77
  %add.1 = add i32 %8, %6, !dbg !78
  %9 = shl nsw i64 %lsr.iv, 2, !dbg !79
  %uglygep20 = getelementptr i8, i8* bitcast ([32000 x i32]* @a to i8*), i64 %9, !dbg !79
  %uglygep2021 = bitcast i8* %uglygep20 to i32*
  %scevgep22 = getelementptr i32, i32* %uglygep2021, i64 6, !dbg !79
  store i32 %add.1, i32* %scevgep22, align 4, !dbg !79
  ...
  %lsr.iv.next = add nsw i64 %lsr.iv, 4, !dbg !80
  %cmp.1 = icmp ult i64 %lsr.iv.next, 31996, !dbg !80
  br i1 %cmp.1, label %for.body, label %for.cond.cleanup, !dbg !72, !llvm.loop !81

; uselistorder directives
  uselistorder i64 %lsr.iv, { 6, 2, 0, 5, 3, 1, 4 }
  uselistorder i64 6, { 1, 0 }
  uselistorder i64 4, { 2, 1, 0 }
  uselistorder [32000 x i32] zeroinitializer, { 0, 1, 2, 3, 4, 7, 8, 9, 10, 11, 12, 5, 6 }
  uselistorder i8* bitcast ([32000 x i32]* @a to i8*), { 0, 3, 1, 2 }
  uselistorder i64 2, { 2, 0, 5, 3, 1, 4 }
...
!3 = !DIFile(filename: "/home/adityanathan/superopt-project/superopt-tests/TSVC_new/s111.c", directory: "/home/adityanathan/superopt-project/superopt-tests/build/TSVC_new")
!4 = !{}
...
!64 = distinct !DISubprogram(name: "s111", scope: !65, file: !65, line: 3, type: !66, scopeLine: 4, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !68)
!65 = !DIFile(filename: "TSVC_new/s111.c", directory: "/home/adityanathan/superopt-project/superopt-tests")
...
!75 = distinct !DILexicalBlock(scope: !76, file: !65, line: 9, column: 36)
!76 = distinct !DILexicalBlock(scope: !70, file: !65, line: 9, column: 3)
!77 = !DILocation(line: 10, column: 22, scope: !75)
!78 = !DILocation(line: 10, column: 20, scope: !75)
