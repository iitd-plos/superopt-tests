; ModuleID = '/home/adityanathan/superopt-project/superopt-tests/LORE_no_mem_write/ex3.c'
source_filename = "/home/adityanathan/superopt-project/superopt-tests/LORE_no_mem_write/ex3.c"
...
define dso_local i32 @ex3() local_unnamed_addr #0 !dbg !47 {
entry:
...
!3 = !DIFile(filename: "/home/adityanathan/superopt-project/superopt-tests/LORE_no_mem_write/ex3.c", directory: "/home/adityanathan/superopt-project/superopt-tests/build/LORE_no_mem_write")
!4 = !{}
...
!47 = distinct !DISubprogram(name: "ex3", scope: !48, file: !48, line: 4, type: !49, scopeLine: 4, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !51)
!48 = !DIFile(filename: "LORE_no_mem_write/ex3.c", directory: "/home/adityanathan/superopt-project/superopt-tests")
...
!67 = !DILocation(line: 8, column: 11, scope: !66)
!68 = !DILocation(line: 8, column: 8, scope: !66)
!69 = distinct !{!69, !64, !70, !71}
!70 = !DILocation(line: 8, column: 18, scope: !56)
...
!75 = !DILocation(line: 8, column: 18, scope: !54)
...
!82 = !DILocation(line: 10, column: 13, scope: !59)
