; ModuleID = '/home/adityanathan/superopt-project/superopt-tests/LORE_no_mem_write/ex4.c'
source_filename = "/home/adityanathan/superopt-project/superopt-tests/LORE_no_mem_write/ex4.c"
...
define dso_local i32 @ex4() local_unnamed_addr #0 !dbg !47 {
entry:
...
!3 = !DIFile(filename: "/home/adityanathan/superopt-project/superopt-tests/LORE_no_mem_write/ex4.c", directory: "/home/adityanathan/superopt-project/superopt-tests/build/LORE_no_mem_write")
!4 = !{}
...
!47 = distinct !DISubprogram(name: "ex4", scope: !48, file: !48, line: 4, type: !49, scopeLine: 4, flags: DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !51)
!48 = !DIFile(filename: "LORE_no_mem_write/ex4.c", directory: "/home/adityanathan/superopt-project/superopt-tests")
...
!66 = !DILocation(line: 8, column: 12, scope: !65)
!67 = !DILocation(line: 8, column: 9, scope: !65)
!68 = distinct !{!68, !63, !69, !70}
!69 = !DILocation(line: 8, column: 19, scope: !56)
!70 = !{!"llvm.loop.isvectorized", i32 1}
!71 = !DILocation(line: 9, column: 10, scope: !57)
!72 = !DILocation(line: 9, column: 7, scope: !57)
!73 = !DILocation(line: 6, column: 29, scope: !58)
!74 = !DILocation(line: 6, column: 20, scope: !58)
!75 = distinct !{!75, !61, !76}
!76 = !DILocation(line: 10, column: 3, scope: !54)
!77 = !DILocation(line: 11, column: 2, scope: !47)
