...
EQCHECK_TARGETS := $(TSVC_PRIOR_TARGETS) $(TSVC_NEW_TARGETS) $(MICRO_TARGETS) $(LOCALMEM_TARGETS) $(TSVC_PRIOR_LOCALS_TARGETS) $(TSVC_NEW_LOCALS_TARGETS) $(POPL_PAPER_EX_TARGETS)
TARGETS :=  $(EQCHECK_TARGETS) $(OTHER_TARGETS) #$(SPEC17_TARGETS) $(OOELALA_TARGETS) # $(CODEGEN_TARGETS)
